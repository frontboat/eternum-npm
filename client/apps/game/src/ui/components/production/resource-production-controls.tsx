...
import { configManager, divideByPrecision, formatTime, getBuildingQuantity } from "@frontboat/eternum";
import { useDojo, useResourceManager } from "@frontboat/react";
import { getBuildingFromResource, RealmInfo, ResourcesIds, StructureType } from "@frontboat/types";
