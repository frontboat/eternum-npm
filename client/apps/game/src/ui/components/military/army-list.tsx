...
import { ArmyManager, getEntityName } from "@frontboat/eternum";
import { useDojo, useExplorersByStructure, useGuardsByStructure } from "@frontboat/react";
import { ClientComponents, StructureType } from "@frontboat/types";
