...
import { getArmy, getRemainingCapacityInKg, toHexString } from "@frontboat/eternum";
import { useDojo, useExplorersByStructure, useGetQuestForExplorer, usePlayerStructures } from "@frontboat/react";
import { ClientComponents, ContractAddress, type ID, ResourcesIds, StructureType } from "@frontboat/types";
